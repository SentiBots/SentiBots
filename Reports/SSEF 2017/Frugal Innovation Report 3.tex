...
\textsc{\LARGE NUS High School of Mathematics and Science}\\[1.5cm] % Name of your university/college
...
\HRule \\[0.4cm]
{ \huge \bfseries A novel and multipurpose autonomous drone platform}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Author:}\\
Sundaramahalingam \textsc{Sudharshan}  \\% Your name
\textsc{Isaac} Tay % Your name
\end{flushleft}
\end{minipage}
~
\begin{minipage}{0.4\textwidth}
...
\emph{Supervisor:} \\
Prahlad \textsc{Vadakkepat} % Supervisor's Name
\end{flushright}
\end{minipage}\\[4cm]
...
\begin{figure}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{sb2.jpg}
		\caption{Prototype 5 (functional)}
		\label{fig:sb-topdown}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{sb1.png}
